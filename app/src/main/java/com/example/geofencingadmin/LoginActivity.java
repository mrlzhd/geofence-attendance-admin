...
import com.example.geofencingadmin.Model.Lecturers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent back = new Intent(LoginActivity.this, LandingPage.class);
                startActivity(back);
                finish();
            }
        });
...
//                Paper.book().write(Prevalent.userPassKey, password);
    ...
    private void AllowAccess(String matric, String pass) {
        ...
        loginRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.child("Admin").child(matric).exists())
                {
                    Lecturers studentsData = snapshot.child("Admin").child(matric).getValue(Lecturers.class);
